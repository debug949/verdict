...
const DARK_VARS: Record<string, string> = {
  ...
  '--lp-nav-bg':          'rgba(10,10,22,0.74)',
  '--lp-nav-border':      'rgba(255,255,255,0.13)',
  '--lp-badge-bg':        'rgba(255,255,255,0.09)',
  '--lp-badge-border':    'rgba(255,255,255,0.17)',
  '--lp-btn-bg':          '#f0f0ff',
  '--lp-btn-text':        '#0c0c12',
  '--lp-btn-sec-bg':      'rgba(255,255,255,0.10)',
  '--lp-btn-sec-text':    '#e8e8f4',
  '--lp-btn-sec-border':  'rgba(255,255,255,0.17)',
  ...
  '--lp-ov-bg':           'rgba(14,14,28,0.93)',
  '--lp-ov-border':       'rgba(255,255,255,0.15)',
  '--lp-ov-text':         '#9898b8',
  '--lp-ov-text-strong':  '#e8e8f4',
  '--lp-ov-divider':      'rgba(255,255,255,0.08)',
  '--lp-ov-zone-bg':      'rgba(255,255,255,0.04)',
  '--lp-toggle-bg':       'rgba(255,255,255,0.11)',
  '--lp-toggle-border':   'rgba(255,255,255,0.17)',
